...
### Heaer formatting & table of contents

> **TODO**: Add header formatting to sections (e.g., “Aim”, “Data”, “Methods”, “Results”, “References”) and Quarto configuration so that a table of contents that is automatically generated from the document headers will be created when the document is rendered
...
The `reference_key` is `click`.

I've added the following in-text citations to the `.qmd` file. Please complete all other in-text citations yourself: 
...
1. After you pushed all changes to your github pages, please go to your github repository ➡️ Click on "Settings" gear icon ➡️ Click on "Pages" on the left panel ➡️ Under "Source", select "Deploy from a branch" ➡️ Under "Branch", select "main" ➡️ Then select "docs" folder from the dropdown menu ➡️ Click on "Save" button.
