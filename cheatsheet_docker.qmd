...
12. Once you are in the terminal, you can test if this command works:

This command will update the base environment with the packages you specified in the conda-lock file.
...
17. 🎉 Final Dockerfile should look like this:
